...
import {
  CreditCard, Plus, Receipt, Save, Trash2, UserPlus,
} from "lucide-react"
...
export function CheckoutDrawer() {
  const {
    ...
    discountType, setDiscountType, discountAmount, setDiscountAmount,
    setTaxRate,
    paymentMethod, setPaymentMethod,
    paidAmountInput, setPaidAmountInput,
    cashAccountId, setCashAccountId,
    bankAccountId, setBankAccountId,
    cashAccounts, bankAccounts, accounts,
    paymentSplits, setPaymentSplits,
    addPaymentSplit, removePaymentSplit, updatePaymentSplit,
