...
export default function PurchasePage() {
  ...
  // Check if user has access to purchases module
  useEffect(() => {
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground">
              You don't have access to the Purchases module. Please contact your administrator.
            </p>
          </CardContent>
        </Card>
      </PageLayout>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <p className="text-muted-foreground">
              This is the Purchases module page. Here you will be able to:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>Create and manage purchase orders</li>
              <li>Track supplier information and relationships</li>
              <li>Manage procurement processes</li>
              <li>Handle purchase invoices and payments</li>
