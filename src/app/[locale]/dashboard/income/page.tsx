...
export default function IncomePage() {
  ...
  if (isCheckingAccess) {
    return (
      <PageLayout title="Income" description="Manage income transactions" maxWidth="full">
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-green-100 text-green-600 dark:bg-green-950/20">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="text-base">
                          <Badge variant="default" className="bg-green-600">Income</Badge>
                        </div>
                      </div>
                      <div>
