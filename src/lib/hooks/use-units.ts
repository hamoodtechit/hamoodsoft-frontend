...
export function useCreateUnit() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(extractError(error, "Failed to create unit. Please try again."))
    },
  })
}
...
export function useUpdateUnit() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(extractError(error, "Failed to update unit. Please try again."))
    },
  })
}
...
export function useDeleteUnit() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(extractError(error, "Failed to delete unit. Please try again."))
    },
  })
}
